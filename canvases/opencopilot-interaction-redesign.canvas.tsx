...
export default function InteractionRedesign() {
  ...
  const [showHistory, setShowHistory] = useCanvasState("show-history", false);
  ...
  return (
    <Stack gap={24} style={{ maxWidth: 960, margin: "0 auto", padding: 24 }}>
      ...
      <Stack gap={16} style={{ 
        ...
        <H1 style={{ marginBottom: 4 }}>OpenCopilot v5 Interaction Redesign</H1>
        <Text tone="secondary" size="small">v5.0 | 全交互跳转补全 | 2026-06-12</Text>
        
        {/* 统计卡片 */}
        <Grid columns={5} gap={12} style={{ marginTop: 8 }}>
          <Stat 
            value="101->52" 
            label="Elements" 
            tone="warning" 
        ...
        <Stack gap={20}>
          <Stack gap={8}>
            ...
            <Text tone="secondary" size="small">
              双击右键唤起，占屏幕 35x45%。Header 极简化（仅 Selection + 翻译/设置）。对话历史增强（复制/应用/来源跳转）。输入框简化。
            </Text>
          </Stack>
          ...
          <Card>
            <CardHeader 
              title="Smart Copilot" 
              trailing={<Pill tone="info">35% x 45% 屏幕</Pill>}
            />
            <CardBody>
              <Stack gap={16}>
                {/* Header 区域 */}
                    ...
                    <Stack gap={16}>
                      ...
                      <Stack gap={8}>
                        ...
                        <Row gap={8} align="center">
                          <Text size="small" tone="secondary" style={{ 
                            padding: "4px 10px",
                          ...
                          <Button variant="primary" size="sm">应用</Button>
                        </Row>
                      </Stack>
                      ...
                      <Stack gap={8}>
                        <Text style={{ 
                          ...
                          根据成本数据计算，Q2 利润率为 23.7%，较 Q1 提升 2.1 个百分点。
                        </Text>
                        <Row gap={8} align="center">
                          <Spacer />
                          <Button variant="ghost" size="sm">复制</Button>
          ...
          <Grid columns={3} gap={16}>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">1. Header 极简</Text>
                <Text size="small" tone="secondary">仅保留 Selection 指示器 + 翻译/设置两个 icon。</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">2. 对话历史增强</Text>
                <Text size="small" tone="secondary">AI 回复下方添加 复制/应用 操作按钮。来源信息可点击跳转。</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">3. 输入框简化</Text>
                <Text size="small" tone="secondary">placeholder 简化为"问点什么..."。</Text>
              </Stack>
            </Card>
          </Grid>
        </Stack>
      ...
      {tab === 1 && (
        <Stack gap={20}>
          <Stack gap={8}>
            ...
            <Text tone="secondary" size="small">
              三击右键唤起，占屏幕 60x65%。精简为 Task / Chat / Files / Memory，Settings 删除。
            </Text>
          </Stack>
          ...
          <Card>
            <CardHeader 
              ...
              trailing={<Pill tone="info">60% x 65% 屏幕</Pill>}
            />
            <CardBody>
              <Row gap={0} style={{ minHeight: 380 }}>
                {/* Sidebar */}
                <Stack gap={0} style={{ 
                  width: 180, 
                  borderRight: "1px solid " + tokens.stroke.tertiary,
                ...
                {/* 主内容区 */}
                <Stack gap={16} style={{ flex: 1, padding: 24, background: tokens.bg.editor }}>
                  ...
                  <Card size="sm">
                    <CardBody>
                      ...
                      <Text size="small" style={{ marginTop: 8 }}>
                        Analyze Q2 data across all departments and produce a summary presentation.
                      </Text>
                    </CardBody>
                  </Card>
                  <Table
          ...
          <Card>
            <CardHeader 
              title="Chat Intent Router" 
              trailing={<Pill tone="info">Auto + 8 意图</Pill>}
            />
            <CardBody>
              <Stack gap={20}>
                ...
                <Card size="sm">
                  <CardBody>
                    <Stack gap={12}>
                      ...
                      <Grid columns={3} gap={16}>
                        <Stack gap={6}>
                          <Text size="small" tone="secondary">识别意图</Text>
                          <Text weight="bold">PPT</Text>
                        </Stack>
                        <Stack gap={6}>
                          <Text size="small" tone="secondary">置信度</Text>
                          <Text weight="bold">92%</Text>
                        </Stack>
                        <Stack gap={6}>
                          <Text size="small" tone="secondary">命中词</Text>
                          <Pill tone="warning">共创、PPT、演示</Pill>
                        </Stack>
                      </Grid>
                    </Stack>
                  </CardBody>
                ...
                <Text size="small" tone="secondary">
                  PPT -> context_meta[ppt_mode=True] | Research -> enable_web_search=True
                </Text>
              </Stack>
            </CardBody>
          </Card>
          ...
          <Grid columns={3} gap={16}>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">1. 稳定导航</Text>
                <Text size="small" tone="secondary">左侧 Sidebar 始终可见: Task / Chat / Files / Memory。</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">2. 任务锚点</Text>
                <Text size="small" tone="secondary">Task 面板是 Chat / Files / Memory 的共同锚点。</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">3. Settings 删除</Text>
                <Text size="small" tone="secondary">Workspace Settings Panel 删除，改为 sidebar 齿轮直接弹 Settings Dialog。</Text>
              </Stack>
            </Card>
          </Grid>
        </Stack>
      ...
      {tab === 2 && (
        <Stack gap={20}>
          <Stack gap={8}>
            ...
            <Text tone="secondary" size="small">
              输入原文 -> 生成PPT -> 编辑PPT -> 导出PPT。IDE式窗口：占屏幕 70-80%，自适应分辨率。
            </Text>
          </Stack>
          ...
          {v5Stage === 0 && (
            <Card>
              <CardHeader 
                title="V5Plus CoCreation" 
                trailing={<Pill tone="info">45x50% | Stage 1</Pill>}
              />
              <CardBody>
                <Stack gap={20}>
                  ...
                  <div style={{
                    ...
                    borderRadius: tokens.radius.md,
                    border: "2px dashed " + tokens.stroke.secondary,
                    minHeight: 120,
                  }}>
                  ...
                  <Row justify="space-between" align="center">
                    ...
                    <Button variant="primary" onClick={() => setV5Stage(1)}>
                      生成 PPT ->
                    </Button>
                  </Row>
                </Stack>
          ...
          {v5Stage === 1 && (
            <Card>
              <CardHeader 
                title="V5Plus - 生成" 
                trailing={<Pill tone="info">60x60% | Stage 2</Pill>}
              />
              <CardBody>
                <Stack gap={20}>
                  ...
                  <Row justify="end">
                    <Button variant="primary" onClick={() => setV5Stage(2)}>
                      开始生成 ->
                    </Button>
                  </Row>
                </Stack>
          ...
          {v5Stage === 2 && (
            <Card>
              <CardHeader 
                title="V5Plus - 编辑导出" 
                trailing={<Pill tone="info">80x80% | Stage 3</Pill>}
              />
              <CardBody>
                <Stack gap={20}>
                              ...
                              <Callout tone="info">
                                <Stack gap={12}>
                                  ...
                                  <Row gap={8}>
                                    ...
                                    <Button variant="ghost" size="sm" onClick={() => setAiDiffAccepted(true)}>
                                      拒绝
                                    </Button>
                                  </Row>
                                </Stack>
                    ...
                    <Stack gap={12}>
                      ...
                      <Row gap={8} align="center" style={{
                        ...
                        <Button 
                          ...
                          style={{
                            background: showHistory ? tokens.fill.tertiary : "transparent",
                          }}
                        >
                          历史
                        </Button>
                      ...
                      {showHistory && (
                        <Card size="sm">
                          <CardBody>
                            <Stack gap={8}>
                              <Text size="small" weight="semibold" tone="secondary">最近指令</Text>
                              {["把标题改为更有吸引力的", "添加一个流程图", "精简第3页内容"].map((cmd, i) => (
                                <Row key={i} gap={8} align="center" style={{
                                  padding: 8,
                                  background: tokens.bg.elevated,
                                  borderRadius: tokens.radius.sm,
                                  ...
                                  <Text size="small" style={{ flex: 1 }}>{cmd}</Text>
                                </Row>
                              ))}
                            </Stack>
                          </CardBody>
            ...
            <CardBody>
              <Grid columns={3} gap={12}>
                {[
                  ...
                  <Card key={i} size="sm" style={{ padding: 16, cursor: "pointer" }}>
                    <Stack gap={8}>
          ...
          <Grid columns={3} gap={16}>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">1. IDE式窗口</Text>
                <Text size="small" tone="secondary">Stage 1:45x50% | Stage 2:60x60% | Stage 3:80x80%</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">2. Stage 2 推荐生成</Text>
                <Text size="small" tone="secondary">文档分析 + 推荐策略（默认金字塔）。</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">3. Stage 3 编辑导出</Text>
                <Text size="small" tone="secondary">60/40 布局：中间 PPT + 右侧原文。Click-to-Edit + AI Diff + 指令历史栏。</Text>
              </Stack>
            </Card>
          </Grid>
        </Stack>
      ...
      {tab === 3 && (
        <Stack gap={20}>
          <Stack gap={8}>
            ...
            <Text tone="secondary" size="small">
              2 入口: SC Header + WS Sidebar (齿轮)。占屏幕 45x55%。Engine 分 Basic + Advanced 折叠。
            </Text>
          </Stack>
          ...
          <Card>
            <CardHeader 
              title="Settings" 
              trailing={<Pill tone="info">45% x 55% 屏幕</Pill>}
            />
            <CardBody>
              <Row gap={0} style={{ minHeight: 400 }}>
                {/* Settings Sidebar */}
                <Stack gap={0} style={{ 
                  width: 140, 
                  borderRight: "1px solid " + tokens.stroke.tertiary,
                  ...
                  {["Engine", "Appearance", "Shortcuts", "Advanced"].map((s, i) => (
                    <Tag 
                      key={i} 
                      active={settingsSection === i} 
                      onClick={() => setSettingsSection(i)}
                      style={{
                        padding: "12px 20px",
                        borderRadius: 0,
                        cursor: "pointer",
                ...
                {/* Settings 内容 */}
                <Stack gap={24} style={{ flex: 1, padding: 24, background: tokens.bg.editor }}>
                  ...
                  <Stack gap={16}>
                    ...
                    {[
                      ...
                      <Row key={item.key} justify="space-between" align="center" style={{
                        padding: 12,
                        background: tokens.bg.elevated,
                        borderRadius: tokens.radius.md,
                        border: "1px solid " + tokens.stroke.tertiary,
              ...
              <CardBody>
                <Stack gap={16}>
                  ...
                  {["PPT Generator - 生成演示文稿", "Translator - 多语言翻译", "Research - 联网调研"].map((r, i) => (
                    <Card key={i} size="sm">
                      <CardBody>
                        <Text size="small" weight="semibold">{r.split(" - ")[0]}</Text>
                        <Text size="small" tone="secondary" style={{ marginTop: 4 }}>{r.split(" - ")[1]}</Text>
                      </CardBody>
                    </Card>
                  ))}
                </Stack>
          ...
          <Grid columns={3} gap={16}>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">1. 入口收敛</Text>
                <Text size="small" tone="secondary">3-4 入口 -> 2 (SC Header + WS Sidebar 齿轮)。</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">2. UI 元素可配置</Text>
                <Text size="small" tone="secondary">Smart Copilot 显示元素和快捷标签默认隐藏，可通过设置开启。</Text>
              </Stack>
            </Card>
            <Card style={{ padding: 20 }}>
              <Stack gap={12}>
                <Text weight="semibold">3. 主题迁移</Text>
                <Text size="small" tone="secondary">原 Studio 底部 4 主题按钮移至 Settings Appearance。</Text>
              </Stack>
            </Card>
          </Grid>
        </Stack>
      ...
      {tab === 4 && (
        <Stack gap={20}>
            ...
            <CardBody>
              <Stack gap={12}>
                {[
                  ...
                  <Row key={i} gap={16} align="center" style={{ 
                    marginLeft: w.level * 28,
                    padding: 12,
                    background: tokens.bg.elevated,
                    borderRadius: tokens.radius.md,
                  }}>
          ...
          <Grid columns={2} gap={16}>
            <Card>
              <CardHeader 
                title="Before: 2 Isolated Chats" 
                trailing={<Pill tone="danger">Problem</Pill>}
              />
              <CardBody>
                <Grid columns={2} gap={12}>
                  <Card size="sm">
                    <CardBody>
                      ...
                      <Text size="small" tone="secondary" style={{ marginTop: 6 }}>Bubble UI / session A / No actions</Text>
                    </CardBody>
                  </Card>
                  <Card size="sm">
                    <CardBody>
                      <Text weight="semibold" size="small">WS Chat Panel</Text>
                      <Text size="small" tone="secondary" style={{ marginTop: 6 }}>Plain HTML / session B / 9 actions</Text>
                    </CardBody>
                  </Card>
                </Grid>
                <Callout tone="danger" style={{ marginTop: 16 }}>
                  NOT connected
                </Callout>
              </CardBody>
            </Card>
            <Card>
              <CardHeader 
                title="After: 1 Unified ChatWidget" 
                trailing={<Pill tone="success">Solution</Pill>}
              />
              <CardBody>
                <Grid columns={2} gap={12}>
                  <Card size="sm">
                    <CardBody>
                      <Text weight="semibold" size="small">SC Chat Tab</Text>
                      <Text size="small" tone="secondary" style={{ marginTop: 6 }}>ChatWidget</Text>
                    </CardBody>
                  </Card>
                  <Card size="sm">
                    <CardBody>
                ...
                <Callout tone="success" style={{ marginTop: 16 }}>
                  Shared session + history + actions
                </Callout>
                <Text size="small" tone="secondary" style={{ marginTop: 8 }}>
                  Bubble UI + action routing + shared session
                </Text>
              </CardBody>
            </Card>
          </Grid>
