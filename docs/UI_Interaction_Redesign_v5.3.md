...
**布局结构**：
- **左侧 60%**：PPT 预览区
  - **模拟 PPT 幻灯片**：显示实际 PPT 内容预览，包含：
    - 封面页：标题 + 副标题 + 渐变背景
    - 核心结论页：要点列表 + 左侧边框装饰
    - 三大支撑页：三栏布局 + 编号图标
  - **幻灯片导航**：点击数字标签切换不同幻灯片（1-6）
  - **AI 建议修改**：Diff Preview，显示具体修改建议（如标题优化），可接受/拒绝
  - **版式选择器**：居中、文本、三栏、图表、时间线，选中状态高亮
- **右侧 40%**：原文区
  - 段落与幻灯片对应关系（如 S2、S3 标签）
  - 指令输入框（改标题、调版式...）
  - **指令历史栏**：点击 📋 按钮展开，显示最近 20 条指令，支持一键复用

**为什么这么设计**：
- 60/40 布局是 IDE 风格标准，用户熟悉
- 原文与 PPT 并排对照，方便内容核对
- PPT 预览区显示实际内容而非空白，避免用户误解
- 模拟幻灯片展示不同版式效果，帮助用户理解当前幻灯片状态
...
**2026-06-12 更新**：
- PPT 预览区真实化：从标题+标签改为模拟 PPT 幻灯片
- 添加封面页、核心结论页、三大支撑页三种幻灯片样式
- 幻灯片导航标签支持点击切换
- 版式选择器增加选中状态高亮
- AI 建议修改显示具体修改内容（如标题优化建议）

---

> **文档版本**：v5.3.1  
> **更新日期**：2026-06-12  
> **设计稿**：opencopilot-interaction-redesign.canvas.tsx (Canvas SDK 组件化版本，PPT 预览区真实化)
