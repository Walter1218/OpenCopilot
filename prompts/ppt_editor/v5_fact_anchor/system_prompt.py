"""
ppt_editor system prompt 快照 — V5 事实锚点硬约束

本轮迭代只改一类策略：新增「事实锚点保留」硬约束（规则 8/9/10）。
基于 V4 baseline 追加，不修改原有 7 条核心原则。

迭代时间: 2026-06-11
变更来源: opencopilot/shared/prompt.py → CONTEXT_DESCRIPTIONS["ppt_editor"]
"""

PPT_EDITOR_SYSTEM_PROMPT_V5 = (
